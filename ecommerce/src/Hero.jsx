...
const Hero =()=>
{
    return( <div className="flex  justify-center my-7  sm:max-sm:flex-col">
    ...
    <div className="flex flex-col sm:flex-row border border-black rounded-lg shadow-lg w-[80%] max-w-[1000px] p-5">
        ...
        <div className="w-1/2 flex justify-center">
            <img
                src={backimg}
                alt="Shopping"
                className="w-full h-auto object-cover rounded-lg   cursor-pointer scale-100 hover:scale-105"
            />
        </div>
